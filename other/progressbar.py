...
class ProgressBarWidget(object):
    ...
    The ProgressBar object will call its update value when an update
    is needed. Its size may change between calls, but the results will
...
class ProgressBarWidgetHFill(object):
    ...
    width this object must be made. This is like TeX \\hfill, it will
